package com.winds.winds_spin_wheel;
...
import com.winds.winds_spin_wheel.model.LuckyItem;
...
public class LuckyWheelView extends RelativeLayout implements PielView.PieRotateListener {
    ...
    private int mSecondaryTextSize2;
    ...
    private void init(Context ctx, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mBackgroundColor = typedArray.getColor(R.styleable.LuckyWheelView_lkwBackgroundColor, 0);
            mTopTextSize = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwTopTextSize, (int) LuckyWheelUtils.convertDpToPixel(4f, getContext()));
            mSecondaryTextSize = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwSecondaryTextSize, (int) LuckyWheelUtils.convertDpToPixel(13f, getContext()));
            mSecondaryTextSize2 = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwSecondaryTextSize, (int) LuckyWheelUtils.convertDpToPixel(13f, getContext()));
            mTextColor = typedArray.getColor(R.styleable.LuckyWheelView_lkwTopTextColor, 0);
            mTopTextPadding = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwTopTextPadding, (int) LuckyWheelUtils.convertDpToPixel(3f, getContext())) + (int) LuckyWheelUtils.convertDpToPixel(3f, getContext());
        ...
        pielView.setSecondaryTextSizeSize2(mSecondaryTextSize2);
